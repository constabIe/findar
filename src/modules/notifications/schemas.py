...
class NotificationTemplateCreate(BaseModel):
    ...
    body_template: str = Field(
        min_length=1, description="Message body template"
    )
    ...
    include_transaction_id: bool = Field(default=True, description="Include transaction ID")
    include_amount: bool = Field(default=True, description="Include transaction amount")
    include_timestamp: bool = Field(default=True, description="Include transaction timestamp")
    include_from_account: bool = Field(default=True, description="Include source account")
    include_to_account: bool = Field(default=True, description="Include destination account")
    include_triggered_rules: bool = Field(default=True, description="Include triggered rules list")
    include_fraud_probability: bool = Field(default=True, description="Include fraud probability")
    include_location: bool = Field(default=False, description="Include transaction location")
    include_device_info: bool = Field(default=False, description="Include device information")
...
class NotificationTemplateUpdate(BaseModel):
    ...
    channel: Optional[NotificationChannel] = Field(None, description="Target notification channel")
    ...
    # Template variables configuration
    include_transaction_id: Optional[bool] = Field(None, description="Include transaction ID")
    include_amount: Optional[bool] = Field(None, description="Include transaction amount")
    include_timestamp: Optional[bool] = Field(None, description="Include transaction timestamp")
    include_from_account: Optional[bool] = Field(None, description="Include source account")
    include_to_account: Optional[bool] = Field(None, description="Include destination account")
    include_triggered_rules: Optional[bool] = Field(None, description="Include triggered rules list")
    include_fraud_probability: Optional[bool] = Field(None, description="Include fraud probability")
    include_location: Optional[bool] = Field(None, description="Include transaction location")
    include_device_info: Optional[bool] = Field(None, description="Include device information")
    
    # Additional custom fields
    custom_fields: Optional[Dict[str, Any]] = Field(None, description="Additional custom template fields")
...
class NotificationTemplateResponse(BaseModel):
    ...
    # Additional custom fields
    custom_fields: Dict[str, Any] = Field(description="Additional custom template fields")
...
class NotificationChannelConfigResponse(BaseModel):
    ...
    # Rate limiting
    rate_limit_per_minute: Optional[int] = Field(description="Maximum notifications per minute")
...
class NotificationDeliveryResponse(BaseModel):
    ...
    # Delivery results
    delivered_at: Optional[datetime] = Field(description="Successful delivery timestamp")
...
class NotificationSendResponse(BaseModel):
    ...
    channels_used: List[NotificationChannel] = Field(description="Channels used for delivery")
...
class NotificationStatsResponse(BaseModel):
    ...
    template_usage: Dict[UUID, int] = Field(
        description="Template usage counts"
    )
...
class NotificationTemplateListResponse(BaseModel):
    ...
    templates: List[NotificationTemplateResponse] = Field(description="List of templates")
...
class NotificationDeliveryListResponse(BaseModel):
    ...
    deliveries: List[NotificationDeliveryResponse] = Field(description="List of deliveries")
